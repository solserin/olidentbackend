                    ...
                    <td align="center">
                        ...
                        <p>Actualizado para el día {{fechahora_completa()}}.</p>
                         @if (count($ventas)>0)
                            ...
                            @if ($vendedor_id)
                                <p>Vendedor: {{$ventas[0]->vendedor}} </p>
                            @else
                                <p>Vendedor: Todos.</p>
                            @endif
            ...
            <tbody>
                ...
                @foreach ($ventas as $venta)
                    <tr>
                        ...
                        <td align="center">{{number_format(($venta->precio-$venta->enganche),2,".",",")}}</td>
                    </tr>
                    @php
                        $x+=1;
                        $total_importe+=$venta->precio;
                        $comision+=$venta->comision_vendedor;
                        $saldo+=($venta->precio-$venta->enganche);
                        $sobreenganche+=$venta->sobre_enganche;
                    @endphp
                @endforeach
                <tr>
                    <td style="height:20px !important;" colspan="4" align="right">
                        <strong>($) Total: </strong>
                    </td>
