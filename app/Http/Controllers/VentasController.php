      ...
      return Ventas::
        ...
        ->with(
          array('beneficiarios'=>function($query){
            $query->select('beneficiarios.id','polizas_id','beneficiarios.nombre','tipo_beneficiarios_id','calle','colonia','numero','cp','localidad_id','ocupacion','edad','telefono','localidades.nombre as localidad','municipios.nombre as municipio')
